...
public class DataSourceConfig {
	...
	lef.setPackagesToScan("me.bcfh.myboard.model");
	lef.getJpaPropertyMap().put("hibernate.search.default.directory_provider", "filesystem");
	lef.getJpaPropertyMap().put("hibernate.search.default.indexBase", config.getFulltextIndexDirectory().toFile().getAbsolutePath());
	return lef;
    }
